...
contract Admin__WithLiquidityEulerDAIFork is EulerDAIFork {
    function testUnitFork_admin1_EulerDAI() public {
    ...
    function testUnitFork_admin2_EulerDAI() public {
    ...
    function testUnitFork_admin3_EulerDAI() public {
    ...
    function testUnitFork_admin4_EulerDAI() public {
    ...
    function testUnitFork_admin6_EulerDAI() public {
